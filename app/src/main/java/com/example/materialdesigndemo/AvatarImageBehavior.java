...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView>{
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.image_width);//设为120dp
    ...
    private void shouldInitProperties(CircleImageView child, View dependency) {
        ...
        // Toolbar缩略图高度
        if (mFinalHeight == 0)
            mFinalHeight = mContext.getResources().getDimensionPixelOffset(R.dimen.image_final_width);//设为50dp
